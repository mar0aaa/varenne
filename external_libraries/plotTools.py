...
_PLOTTOOLS_DIR = os.path.dirname(os.path.abspath(__file__))
...
def blockShapeDiagram(x,y,z,perc=1.0):
	...
	plt.legend(prop={'size': 12}, loc='upper left', bbox_to_anchor=(1.01, 1.0), borderaxespad=0)
	img = imread(os.path.join(_PLOTTOOLS_DIR, "TriangularPlot.png"))
